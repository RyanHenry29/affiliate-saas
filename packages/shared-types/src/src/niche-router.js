...
exports.NicheRouter = exports.NICHE_RULES = void 0;
exports.NICHE_RULES = [
    {
        tag: 'DONA_DE_CASA',
        keywords: [
...
class NicheRouter {
    static classify(title) {
        const normalized = title
            .normalize('NFD')
            .replace(/[\u0300-\u036f]/g, '')
            .toLowerCase();
        for (const rule of exports.NICHE_RULES) {
...
exports.NicheRouter = NicheRouter;
//# sourceMappingURL=niche-router.js.map